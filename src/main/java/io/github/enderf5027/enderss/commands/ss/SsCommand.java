...
public class SsCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        PlayerSession susSession = SessionManager.getSession(sus);
        PlayerSession staffSession = SessionManager.getSession(staff);
        ...
        sendListMessage(config.staffmessage, staff, sus, staff);
